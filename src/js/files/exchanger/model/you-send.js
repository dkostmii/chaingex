import YouSendView from '../views/you-send.js';
...
/**
 * Represents a model for {@link YouSendView}.
 */
class YouSend {
  /**
   * Creates a new instance of {@link YouSend} model.
  ...
  /**
   * Gets the minimum amount of cryptocurrency to send.
   * 
   * @returns {number}
   */
  get minAmount() {
